...
namespace Mscc.GenerativeAI
{
    public static class GenerativeAIExtensions
    {
        ...
        public static Part FromFunctionResponse(this Part part, string name)
        {
            if (string.IsNullOrEmpty(name)) return part;
        ...
        {
            if (response.PromptFeedback is { BlockReason: not BlockedReason.BlockedReasonUnspecified })
            {
