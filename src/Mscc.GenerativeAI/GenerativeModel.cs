...
namespace Mscc.GenerativeAI
{
    public class GenerativeModel : BaseModel
    {
        ...
        /// <remarks/>
        public async Task<GenerateContentResponse> GenerateContent(List<Part>? parts,
            GenerationConfig? generationConfig = null,
            List<SafetySetting>? safetySettings = null,
            List<Tool>? tools = null,
            ToolConfig? toolConfig = null,
        ...
        /// <remarks/>
        public IAsyncEnumerable<GenerateContentResponse> GenerateContentStream(List<Part>? parts,
            GenerationConfig? generationConfig = null,
            List<SafetySetting>? safetySettings = null,
            List<Tool>? tools = null,
            ToolConfig? toolConfig = null,
...
//            request.Parameters.AddWatermark = addWatermark;
        ...
        /// <remarks/>
        public async Task<CountTokensResponse> CountTokens(List<Part>? parts, 
            CancellationToken cancellationToken = default)
        {
            if (parts == null) throw new ArgumentNullException(nameof(parts));
            ...
            bool enableAutomaticFunctionCalling = false)
        {
            ...
            if (_cachedContent is not null)
            {
                history ??= _cachedContent.Contents?.Select(c =>
                    new ContentResponse { Role = c.Role, Parts = c.Parts }
                ).ToList();
            }
