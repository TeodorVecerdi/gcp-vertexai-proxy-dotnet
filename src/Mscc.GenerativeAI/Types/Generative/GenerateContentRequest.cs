...
namespace Mscc.GenerativeAI
{
    ...
    public class GenerateContentRequest
    {
            ...
            ToolConfig? toolConfig = null) : this()
        {
            ...
            Contents = new List<Content> { new Content { Role = Role.User, Parts = new List<Part> { new() { Text = prompt } } } };
            ...
            ToolConfig? toolConfig = null) : this()
        {
            ...
            Contents = new List<Content> { new Content { Role = Role.User, Parts = new List<Part> { new() { FileData = new FileData { FileUri = file.Uri, MimeType = file.MimeType } } }, } };
            if (generationConfig != null) GenerationConfig = generationConfig;
            if (safetySettings != null) SafetySettings = safetySettings;
            if (tools != null) Tools = tools;
            if (systemInstruction != null) SystemInstruction = systemInstruction;
        ...
        public async Task AddMedia(string uri, string? mimeType = null, bool useOnline = false)
        {
            ...
            if (useOnline)
            {
                ...
                AddPart(new Part { FileData = new FileData { FileUri = uri, MimeType = mimeType } });
            ...
            else
            {
                ...
                GenerativeAIExtensions.GuardMimeType(mimeType);
                AddPart(new Part { InlineData = new InlineData { MimeType = mimeType, Data = base64data } });
            }
        }
        ...
        public void AddMedia(FileResource file)
        {
            ...
            AddPart(new Part() { FileData = new FileData() { FileUri = file.Uri, MimeType = file.MimeType } });
        }
        ...
        public void AddPart(Part part, int index = 0)
        {
